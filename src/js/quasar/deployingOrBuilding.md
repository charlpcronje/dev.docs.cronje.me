---
title: Deploying an SPA in Quasar | CRONje.ME
...
*Since Vercel expects the build results to be in `/public` directory, and _Quasar_ has it in `/dist/spa` by default, consider updating `quasar.conf.js` accordingly:*
